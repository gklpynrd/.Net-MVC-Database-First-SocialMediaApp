...
namespace SocialMediaApp.Models
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="SocialMediaAppDb")]
	public partial class SocialMediaAppDbDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertUserChat(UserChat instance);
    partial void UpdateUserChat(UserChat instance);
    partial void DeleteUserChat(UserChat instance);
        #endregion

        public SocialMediaAppDbDataContext() :
                base(global::System.Configuration.ConfigurationManager.ConnectionStrings["SocialMediaAppDbConnectionString"].ConnectionString, mappingSource)
        {
            OnCreated();
        }

        public SocialMediaAppDbDataContext(string connection) :
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SocialMediaAppDbDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SocialMediaAppDbDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SocialMediaAppDbDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<UserChat> UserChats
		{
			get
			{
				return this.GetTable<UserChat>();
			}
		}
	}
	...
	public partial class aspnet_User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<UserChat> _UserChats;
		
		private EntitySet<UserChat> _UserChats1;
    ...
    partial void OnProfilePictureChanged();
		...
		public aspnet_User()
		{
			...
			this._UserChats = new EntitySet<UserChat>(new Action<UserChat>(this.attach_UserChats), new Action<UserChat>(this.detach_UserChats));
			this._UserChats1 = new EntitySet<UserChat>(new Action<UserChat>(this.attach_UserChats1), new Action<UserChat>(this.detach_UserChats1));
			this._aspnet_Application = default(EntityRef<aspnet_Application>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_Post", Storage="_Posts", ThisKey="UserId", OtherKey="Userid")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_UserChat", Storage="_UserChats", ThisKey="UserId", OtherKey="UserId")]
		public EntitySet<UserChat> UserChats
		{
			get
			{
			...
			set
			{
				this._UserChats.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_UserChat1", Storage="_UserChats1", ThisKey="UserId", OtherKey="ReceiverId")]
		public EntitySet<UserChat> UserChats1
		{
			get
			{
				return this._UserChats1;
			}
			set
			{
				this._UserChats1.Assign(value);
			}
		}
		...
		private void attach_UserChats(UserChat entity)
		{
			this.SendPropertyChanging();
			entity.aspnet_User = this;
		}
		
		private void detach_UserChats(UserChat entity)
		{
			this.SendPropertyChanging();
			entity.aspnet_User = null;
		}
		
		private void attach_UserChats1(UserChat entity)
		{
			this.SendPropertyChanging();
			entity.aspnet_User1 = this;
		}
		
		private void detach_UserChats1(UserChat entity)
		{
			this.SendPropertyChanging();
    ...
    partial void OnidChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Chat_UserChat", Storage="_UserChats", ThisKey="id", OtherKey="ChatId")]
		public EntitySet<UserChat> UserChats
		{
			get
			{
	...
	public partial class Post : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Data.Linq.Binary _PostPicture;
    ...
    partial void OnPostPictureChanging(System.Data.Linq.Binary value);
    partial void OnPostPictureChanged();
    ...
    partial void OnDateAddedChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PostPicture", DbType="Image", UpdateCheck=UpdateCheck.Never)]
		public System.Data.Linq.Binary PostPicture
		{
			get
			{
				return this._PostPicture;
			}
			set
			{
				if ((this._PostPicture != value))
				{
					this.OnPostPictureChanging(value);
					this.SendPropertyChanging();
					this._PostPicture = value;
					this.SendPropertyChanged("PostPicture");
					this.OnPostPictureChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PostText", DbType="NVarChar(250)")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_Post", Storage="_aspnet_User", ThisKey="Userid", OtherKey="UserId", IsForeignKey=true)]
		public aspnet_User aspnet_User
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.UserChats")]
	public partial class UserChat : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnReceiverIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_UserChat", Storage="_aspnet_User", ThisKey="UserId", OtherKey="UserId", IsForeignKey=true)]
		public aspnet_User aspnet_User
		{
			get
			{
			...
			set
			{
							...
							|| (this._aspnet_User.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._aspnet_User.Entity = null;
						previousValue.UserChats.Remove(this);
					}
					this._aspnet_User.Entity = value;
					if ((value != null))
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_UserChat1", Storage="_aspnet_User1", ThisKey="ReceiverId", OtherKey="UserId", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._aspnet_User1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.UserChats1.Remove(this);
					}
					this._aspnet_User1.Entity = value;
					if ((value != null))
					{
						value.UserChats1.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Chat_UserChat", Storage="_Chat", ThisKey="ChatId", OtherKey="id", IsForeignKey=true)]
		public Chat Chat
		{
			get
			{
